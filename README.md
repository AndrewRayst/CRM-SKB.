...
Для запуска:
* Нужно установить нужные пакеты командой: `npm install --legacy-peer-deps`
* Запустить `npm run start`
* Запустить сервер (об этом ниже)

После этого приложение будет доступно по `http://localhost:5000/`
